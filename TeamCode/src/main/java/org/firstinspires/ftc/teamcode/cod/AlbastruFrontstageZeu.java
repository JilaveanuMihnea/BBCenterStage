...
@Disabled
@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name="Autonomy: Albastru Frontstage Zeu", group="Autonomy")
public class AlbastruFrontstageZeu extends ScheletAlbastru{
