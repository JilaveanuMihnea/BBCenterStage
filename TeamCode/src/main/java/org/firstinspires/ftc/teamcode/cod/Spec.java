...
public class Spec {
    ...
    public static float OPENED_POS_RIGHT = 0.45f; // 5

    public static float HOLD_ALIGN = 0.54f; // creste = mai jos +0.07 pt hold place
    public static float HOLD_PLACE = 0.59f;
